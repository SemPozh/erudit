...
Он описывает 92 операции по 20 тегам: 6 реализованных и 86 запланированных
по задачам проекта. Запланированные маршруты помечены в контракте и пока
возвращают 404. Их пути и структуры запросов — основа для будущих контроллеров.
